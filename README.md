...
[the "Features List" section](https://github.com/d0iasm/rvemu#features-list) for
...
**Linux**
```
$ ./target/release/rvemu-cli -k examples/linux-bbl.bin -f examples/busybear.bin
```
